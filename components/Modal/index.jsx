                        ...
                        <div>
                            ...
                            <div className="Modal__Text__Wrapper">
                                ...
                                <div className="Modal__Text">
                                    <p>Каждый год в России угоняют более XX мотоциклов. Мотоцикл всегда был лакомным куском для угонщиков
                                        из-за того, что украсть его довольно легко. Реальных способов защититься не так много.
                                        Пристегнуть цепью к забору? Гидравлическими кусачками можно перекусить любую цень.
                                        Сигнализация? Требуется секунд тридцать, что бы погрузить мотоцикл в газель. Скорее всего Вы не успеете выбежать за это время
                                        Охраняемая парковка. На наш взгляд это самая действенная защита. Конечно и тут не все идеально, но у угонщиков должна быть действительно сильная мотивация,
                                        что бы применить физическую силу к охраннику.

                                        Каждую ночь кто-то оставляет свой мотоцикл у подъезда, провоцируя угонщиков увеличить это число.</p>
                                    <p>Самый действенный способ не пополнить число обокраденных, это оставлять сво</p>
                                    <p>3. кто решает</p>
